...
//
    ...
    @ResponseBody
    public VivoCommonRespDTO ServletRequestBindingException(ServletRequestBindingException e, HttpServletResponse response){
//        ResponseDTO responseDTO = new ResponseDTO(Constants.resultCode.PARAM_VALUE_INVALID,Constants.systemError.PARAM_VALUE_INVALID, new Object[] {"main"});
        VivoCommonRespDTO responseDTO = new VivoCommonRespDTO();
