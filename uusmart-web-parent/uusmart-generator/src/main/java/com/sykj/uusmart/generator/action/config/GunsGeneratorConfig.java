package com.sykj.uusmart.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.sykj.uusmart.admin.common.persistence.model");
        packageConfig.setMapper("com.sykj.uusmart.admin.common.persistence.dao");
        packageConfig.setXml("com.sykj.uusmart.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.sykj.uusmart.admin");
        contextConfig.setCoreBasePackage("com.sykj.uusmart.core");
